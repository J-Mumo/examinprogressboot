...
## Execute SQL scripts
################################################################################
echo $COMMENT_PREFIX "Executing  0002_insert_standing_data_rollback.sql"
PGPASSWORD=$PSQL_PASSWORD psql --host=$PSQL_HOST  --port=$PSQL_PORT -d $PSQL_DB -U $PSQL_USER -f 0002_insert_standing_data_rollback.sql

echo $COMMENT_PREFIX "Executing 0001_create_db_rollback.sql"
PGPASSWORD=$PSQL_PASSWORD psql --host=$PSQL_HOST  --port=$PSQL_PORT -d $PSQL_DB -U $PSQL_USER -f 0001_create_tables_rollback.sql
